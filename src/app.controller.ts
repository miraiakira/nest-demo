...
export class AppController {
  ...
  uploadFileFileds(@UploadedFiles() files: { aaa?: Express.Multer.File[], bbb?: Express.Multer.File[] }, @Body() body) {
    console.log('body', body)
  ...
  uploadFile2(@UploadedFile(FileSizeValidationPipePipe) file: Express.Multer.File, @Body() body) {
    console.log('body', body)
    console.log('file', file)
  }
